...
// the elements should go up by increments of one, corresponding to the old behavior. The function call range(1, 10, 2) should return [1, 3, 5, 7, 9]. 
...
function range(start, end, step) {
  ...
  for (let i = start; i <= end; step ? i += step : i++) numbers.push(i)
